import { fetchTodaysInsights, getTokenInfo, getDailyBudget, fetchAdSetInsights, fetchTodaysAccountSpend } from './metaClient.js';
import { 
  ruleTokenExpiration, 
...
export async function runChecks() {
  ...
  try {
    ...
    const [tokenInfo, todaysInsights, dailyBudget, accountSpend] = await Promise.all([
      getTokenInfo(),
      fetchTodaysInsights(),
      getDailyBudget(),
